...
export function endpoint({ TICKER }:Req_params, query:Req_query) {
  return builder.stringify([config.baseUrl, 'market-aggregation', TICKER], query)
}
...
// ==================== Sample ==================== //
// ================================================ //
export const sample_req = 'https://project-finance-backend.onrender.com/market-aggregation/MSFT?tframe=Year&until=max&asc=false'
